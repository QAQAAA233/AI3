...
from .settings import ERROR_REPORTS_DIR

logger = logging.getLogger(__name__)


class ErrorReporter:
    """Generate structured error reports to help with diagnostics."""
    ...
    def generate_report(
        ...
        """Create a Markdown report describing the failure."""
    ...
    def _get_fix_suggestions(error_type: str, error_message: str) -> str:
        """Provide targeted suggestions for known errors."""
        suggestions = {
            "JSON_DECODE_ERROR": """\
